...
//Caesar Cipher
export async function CaesarEncrypt(input,shifts) {
return encrypt(input, shifts)
}
export async function CaesarDecrypt(input,shifts) {
...
export async function MonoEncrypt(input,key) {
...
export async function MonoDecrypt(input,key) {
    const monoalphabeticCipher = new MonoAlphabeticCipher({
        substitution: key
    });
...
export async function PolyEncrypt(str,keyword) {
...
export async function PolyDecrypt(str,keyword) {
...
export async function HillEncrypt(msg,keyword) {
...
export async function HillDecrypt(cipher,keyword) {
...
export async function PlayfairEncrypt(str, key) {
  let ps, ks;
...
export async function PlayfairDecrypt(str, key) {
  ...
  export async function DESEncrypt(plaintext, key) {
      class DES {
            constructor(key) {
...
return des.encrypt(plaintext);
  ...
  export async function DESDecrypt(ciphertext, key) {
    class DES {
      constructor(key) {
        this.key = CryptoJS.enc.Hex.parse(key);
      }
...
export async function RSAEncrypt(message, n,ed) {
  const encryptedMessage = convertMessageToAscii(message, ed, n);
return encryptedMessage;
}

export async function RSADecrypt(message, n,ed) {
